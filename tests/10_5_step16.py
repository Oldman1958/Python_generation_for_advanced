...
# Потом подумал, почитал и посмотрел, разобрался и решил через zip().
result = [{ids: {name: grade} for ids, name, grade in zip(student_ids, student_names, student_grades)}]
