...
Дополните приведенный код, используя генератор, так, чтобы получить словарь result, в котором числа будут ключами,
а слова – значениями.
...
result = {int(key): val for key, val in (i.split(':') for i in s.split())} # сначала создаем кортеж!
