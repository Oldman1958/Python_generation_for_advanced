...
чтобы он выбрал из списка files уникальные имена файлов c расширением .png, независимо от регистра имен и расширений.
...
myset = {el.lower() for el in files if el[-4:].lower() == '.png'}
print(*sorted(myset))
